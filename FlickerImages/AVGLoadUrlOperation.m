...
- (void)main {
    ...
    NSString *urlBaseString = @"https://api.flickr.com/services/rest/?"
        "method=flickr.photos.search&"
        "license=1,2,4,7&"
        "has_geo=1&"
        "extras=original_format,description,date_taken,geo,date_upload,owner_name,place_url,tags&"
        "format=json&"
        "api_key=c55f5a419863413f77af53764f86bd66&nojsoncallback=1&";
